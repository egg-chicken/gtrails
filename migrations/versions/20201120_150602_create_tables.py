...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("routeType", sa.String(length=50), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("trailConditions", sa.String(length=100), nullable=False),
        sa.Column("createdAt", sa.DateTime(), server_default=sa.func.current_timestamp(), nullable=False),
        sa.Column("updatedAt", sa.DateTime(), server_default=sa.func.current_timestamp(), nullable=False),
        sa.PrimaryKeyConstraint("id"),
        sa.ForeignKeyConstraint(["userId"], ["users.id"]),
    ...
    op.create_table(
        "list_location",
        sa.Column("listId", sa.Integer(), primary_key=True),
        sa.Column("locationId", sa.Integer(), primary_key=True),
    ...
    if environment == "production":
        ...
        op.execute(f"ALTER TABLE list_location SET SCHEMA {SCHEMA};")
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table("users", "locations", "reviews", "activities", "act_tag_loc", "lists", "list_location")
    # ### end Alembic commands ###
