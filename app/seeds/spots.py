...
def seed_spots():
    ...
    s3 = Spot(name='Drift Creek Suspension Bridge and Waterfall', userId=1, address='add 1', city='', state='Oregon', country='country1', lat=44.876667, lng=122.64805, description='text lol', length=8, elevGain=100, routeType='Loop', image='url 3', createdAt= datetime(2021,11,19), updatedAt= datetime(2021,11,19))
