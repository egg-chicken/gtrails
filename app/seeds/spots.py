...
def seed_spots():
    ...
    s1 = Spot(name='Trail of Ten Falls', userId=1, address='Silver Falls State Park, Silverton, OR 97381', city='Silverton', state='Oregon', country='USA', lat=44.876667, lng=-122.64805, description='This is a moderate hike which loops you around 10 waterfalls', length=7.2, elevGain=800, routeType='Loop', image='https://res.cloudinary.com/dc5lrkblw/image/upload/v1695495516/gtrails/silverfalls-waterfall.jpg', createdAt= datetime(2023,4,21), updatedAt= datetime(2023,4,21))
